...
namespace EasyFreight.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //Check Super User
        public ActionResult CheckIfSuperUser()
        {
            string userId = User.Identity.GetUserId();
            bool isSuper = EasyFreight.Areas.Admin.DAL.UserManagementHelper.IsSuperUser(userId);
            return Json(isSuper);
        }
        ...
        [CheckRights(ScreenEnum.Security,ActionEnum.Add)]
        ...
        public ActionResult ResetPass(string userID)
        {
            try
            {
                ...
                Session["hdnFlag"] = userID;
            }
            catch {
                return RedirectToAction("UsersList", "Admin/Security");
            }
            return View();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> ResetPass(ManageUserViewModel model)
        {

            UserManager<IdentityUser> userManager =  new UserManager<IdentityUser>(new UserStore<IdentityUser>());
            var userId  = Session["hdnFlag"].ToString() ;// model. "4c51c6cd-7a17-4861-a338-4b63746213e9";
            ...
            //String userId = "4c51c6cd-7a17-4861-a338-4b63746213e9"; //User.Identity.GetUserId();//"<YourLogicAssignsRequestedUserId>";
            //String newPassword = "test@123"; //"<PasswordAsTypedByUser>";
            //String hashedNewPassword = UserManager.PasswordHasher.HashPassword(newPassword);
            //ApplicationUser cUser = await UserManager.FindByIdAsync(userId);

            //userManager.AddPassword(cUser,hashedNewPassword);
